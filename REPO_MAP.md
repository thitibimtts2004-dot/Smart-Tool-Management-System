...
| `eslint.config.mjs` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `firebase.json` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `firestore.rules` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `next-env.d.ts` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `next.config.ts` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `package-lock.json` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `package.json` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `tsconfig.json` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
| `tsconfig.tsbuildinfo` | _(TODO: describe — auto-added 2026-06-29 by repo_map_check)_ |
## Directories

<!-- REPO-STRUCTURE:AUTO (generated by repo_map_check.py --sync · do not hand-edit) -->
_Auto-generated structure snapshot — repo_map_check.py --sync (2026-06-29). Do not hand-edit between these markers; curated descriptions live outside._
...
| `.agents\skills\harness\token_auditor/` | 1 | 0 |
| `.agents\skills\harness\token_tracker/` | 1 | 0 |
...
| `src\app/` | 4 | 0 |
| `src\components/` | 0 | 2 |
| `src\components\common/` | 3 | 0 |
| `src\components\layout/` | 1 | 0 |
| `src\hooks/` | 2 | 0 |
| `src\lib/` | 0 | 1 |
| `src\lib\firebase/` | 2 | 0 |
| `src\types/` | 1 | 0 |
<!-- /REPO-STRUCTURE:AUTO -->
...
### `public/`
_(TODO: describe — auto-added 2026-06-29 by repo_map_check)_
