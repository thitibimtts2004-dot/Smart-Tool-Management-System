...
_Auto-generated structure snapshot — repo_map_check.py --sync (2026-06-23). Do not hand-edit between these markers; curated descriptions live outside._
...
| `.agents/skills/knowledge/` | 0 | 4 |
| `.agents/skills/knowledge/file_manager/` | 1 | 0 |
| `.agents/skills/knowledge/repo_researcher/` | 1 | 0 |
| `.agents/skills/knowledge/session_manager/` | 2 | 0 |
| `.agents/skills/knowledge/variable_manager/` | 1 | 0 |
