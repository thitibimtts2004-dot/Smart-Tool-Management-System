...
| CHAT_TOTAL | Action |
|---|---|
| >120k | ⚠️ Recommend: "Context window หนักมาก — แนะนำ /compact ก่อนงานถัดไป" |
| >180k | 🛑 Force: "Context window เต็มแล้ว — /compact บังคับก่อนรับงานใหม่" · ไม่รับงานใหม่จนกว่าจะ compact |
