...
- Token: SESSION 60-80k → finish step → `[token-pause]` · thresholds → C0 Q3 (§Per-Turn Routing) · hard STOP SESSION>90k OR CHAT>120k → `[compact-STOP]`
